...
export const metadata = {
    ...
    description: 'Gerencia seu perfil profissional e prepare suas próximas apresentações.',
}

export default function PainelLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen bg-bg-app">
            <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-suface px-4 sm:px-6">
                <Link
                    href='/painel'
